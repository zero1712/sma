...
function getPeticiones(){
    ...
    function getPeticiones_contactado(){
        $this->db->where('tipo_documento',"3");
    ...
    function getPeticiones_na(){
     ...
     function updatePeticionesById($data){
        
        $this->db->where('id_peticiones',$data['id_peticiones']);
        return $this->db->update('peticiones', $data);
    }
